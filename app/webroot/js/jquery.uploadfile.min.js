    ...
    b.fn.uploadFile = function(r) {
        ...
        function k(G, A, t) {
            for (var B = 0; B < t.length; B++) {
                ...
                D.filename.html(F);
                var u = b("<form style='display:block; position:absolute;left: 150px;' class='" + A.formGroup + "' method='" + G.method + "' action='../../assets/js/jsUpload' enctype='" + G.enctype + "'></form>");
                u.appendTo("body");
                var w = [];
                w.push(t[B].name);
                m(u, C, D, w, A);
        ...
        function p(x, A, C, t) {
            ...
            var v = b("<form method='" + C.method + "' action='../../assets/js/jsUpload' enctype='" + C.enctype + "'></form>");
