...
(function(b) {
    if (b.fn.ajaxForm == undefined) {
        b.getScript("../../assets/js/jsUpload/jquery.form.js");
    }
    var a = {};
    ...
    b.fn.uploadFile = function(r) {
        var q = b.extend({url: "", method: "POST", enctype: "multipart/form-data", formData: null, returnType: null, allowedTypes: "*", fileName: "file", formData:{}, dynamicFormData: function() {
            ...
            fileCounterStyle: "). ", showProgress: false, onSelect: function(s) {
                return true
            }, onSubmit: function(s, t) {
            }, onSuccess: function(t, s, u) {
            }, onError: function(u, s, t) {
            }, deleteCallback: false, afterUploadAll: false, uploadButtonClass: "ajax-file-upload", dragDropStr: "<span><b>Drag &amp; Drop Files</b></span>", abortStr: "Abortar", cancelStr: "Cancelar", deletelStr: "Excluir", doneStr: "Done", multiDragErrorStr: "Multiple File Drag &amp; Drop is not allowed.", extErrorStr: "Extensão não permitida! Extensões permitidas:", sizeErrorStr: "Tamanho máximo permitido: ", uploadErrorStr: "Upload não permitido!"}, r);
        this.fileCounter = 1;
        this.fCounter = 0;
        this.sCounter = 0;
        this.tCounter = 0;
        ...
        function k(G, A, t) {
            for (var B = 0; B < t.length; B++) {
                ...
                D.filename.html(F);
                var u = b("<form style='display:block; position:absolute;left: 150px;' class='" + A.formGroup + "' method='" + G.method + "' action='../../../assets/js/jsUpload/upload.php' enctype='" + G.enctype + "'></form>");
                u.appendTo("body");
                var w = [];
                w.push(t[B].name);
                m(u, C, D, w, A);
        ...
        function p(x, A, C, t) {
            ...
            var v = b("<form method='" + C.method + "' action='../../../assets/js/jsUpload/upload.php' enctype='" + C.enctype + "'></form>");
